...
write.df(exportCsv_SON, "januar_hell_sommer_heiss_SON_NEG.csv", "com.databricks.spark.csv", "overwrite")
...
write.df(exportCsv_SCH, "januar_hell_sommer_heiss_SCH_NEG.csv", "com.databricks.spark.csv", "overwrite")
...
write.df(exportCsv_TEMP, "januar_hell_sommer_heiss_TEMP_NEG.csv", "com.databricks.spark.csv", "overwrite")
